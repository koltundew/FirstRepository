...
public class LibraryControl {
    ...
    private void printBooks() {
       printer.printBooks(library.getSortedPublications((p1,p2) ->
               p1.getTitle().compareToIgnoreCase(p2.getTitle())));
    }

    private void printMagazines() {
        printer.printMagazines(library.getSortedPublications((p1,p2) ->
                p1.getTitle().compareToIgnoreCase(p2.getTitle())));
    }

    private void printUsers(){
        printer.printUsers(library.getSortedUsers((p1,p2 ) ->
